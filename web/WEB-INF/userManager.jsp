                                                    ...
                                                    <tr>
                                                            <td>
                                                                    <select name='editStatus' id='editStatus'>
                                                                            <option value='Active' ${selectedUser.isActive() ? 'selected' : ''}>Active</option>
                                                                            <option value='Inactive' ${!selectedUser.isActive() ? 'selected' : ''}>Inactive</option>
                                                                    </select>
                                                            </td>
                                                    </tr>
                                                    <tr>
                                                            <td>
                                                                    <select name='editRole' id='editRole'>
                                                                            <option value='Regular User' ${selectedUser.getUserRole().getRoleID() == 2 ? 'selected' : ''}>Standard User</option>          
                                                                            <option value='Company Administrator' ${selectedUser.getUserRole().getRoleID() == 3 ? 'selected' : ''}>Company Administrator</option>
                                                                            <option value='System Administrator' ${selectedUser.getUserRole().getRoleID() == 1 ? 'selected' : ''}>System Administrator</option>
                                                                    </select>
                                                            </td>
                                                    </tr>
                                                    <tr>
